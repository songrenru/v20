...
class Error
{
    ...
    public function init(App $app)
    {
        ...
        //非开发环境屏蔽notice错误提示
        if(isset($_SERVER['HTTP_HOST']) && (stripos($_SERVER['HTTP_HOST'], '.group.com') !== false || stripos($_SERVER['HTTP_HOST'], 'o2o-local') !== false || stripos($_SERVER['HTTP_HOST'], 'o2otest') !== false)){
